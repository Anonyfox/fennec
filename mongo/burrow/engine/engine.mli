...
val open_ : ?durability:Store.durability -> ?map_size_gb:int -> string -> t
(** Open (creating if absent) the engine over an on-disk directory; the catalog is rebuilt from it. *)
