let render () =
  String.concat "\n"
    [ "# Fennec";
      "";
      "Fennec is an OCaml fullstack framework built on plain dune projects. Use the CLI as the source of truth for task discovery, builds, dev feedback, tests, docs, and agent fastlane feedback.";
      "";
      "## Start Here";
      "";
      "```sh";
      ...
      "## Agent Fastlane";
      "";
      "After editing, coding agents should use the hook fastlane. Do not run manual `dune build` / `dune runtest` probes after every edit.";
      "";
