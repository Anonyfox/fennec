(* accounts.ml — the public Accounts facade. The type model + core operations live in
   {!Accounts_base} (included below); Codec / Collection_store / the Methods functor / Store
   follow here. This file satisfies accounts.mli. *)
...
(* ---- storage backends + the native singleton: re-exported from {!Accounts_native} ---- *)
