(* Livereload system test (ported from livereload.sh). Runs the REAL `fennec dev` and guards the
   ways livereload has actually broken before — deterministically, no browser. Contained (the whole
